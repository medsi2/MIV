...
unsigned int nTargetSpacing = 1 * 30; // 30 secs quick retargetspacing
...
const string strMessageMagic = "makeitviral Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight < 50) // MAKEITVIRAL ICO RESERVED
    {
        nSubsidy = 1000000000 * COIN; // 100 Milion
    }
...
// makeitviral: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "makeitviral", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Airlines try to ease laptop ban headache for passengers";
        CTransaction txNew;
        txNew.nTime = 1490374650;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xe62084d00baf7cf36b033cc4d6683374e89463c9e394d3d18977a3f1b5f1830c"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xd4, 0x3c, 0xa3, 0x34 };
